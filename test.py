...
# -*- coding: utf-8 -*-
#
#   This file is part of Send tweet with media.
#   Copyright (C) 2020-2022, Send tweet with media Developers.
#
#   Please refer to AUTHORS.rst for a complete list of Copyright holders.
#
#   Send tweet with media is free software: you can redistribute it and/or modify
#   it under the terms of the GNU General Public License as published by
#   the Free Software Foundation, either version 3 of the License, or
#   (at your option) any later version.
#
#   Send tweet with media is distributed in the hope that it will be useful,
